<div class="row">
    ...
    @if ($products->isEmpty())
        <h3>Không tìm thấy sản phẩm phù hợp với từ khóa "{{ request('search-product') }}".</h3>
    @else
                ...
                <div class="block2">
                    ...
                    <div class="block2-txt flex-w flex-t p-t-14">
                        <div class="block2-txt-child1 flex-col-l ">
                            ...
                            <span class="stext-105 cl3 p-b-6">
                                {!! \App\Helpers\Helper::price($product->price) !!}
                            </span>

                            {{-- <span class="stext-111 cl3">
                        Còn lại: {!! \App\Helpers\Helper::soluong($product->Soluong) !!}
                    </span> --}}
                        </div>
